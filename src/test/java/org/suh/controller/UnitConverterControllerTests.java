...
@Log4j
public class UnitConverterControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/register").param("fromunit", "1124")
						.param("expression", "test expression").param("tounit", "1126"))
